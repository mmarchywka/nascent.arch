...
// QUICKCOMPILE  g++  -Wall -std=gnu++11 -DTEST_MJM_CHROMATE -I. -I../../mjm/hlib -I../../mjm/num  -I../../pkg/include -Wno-unused-variable -Wno-misleading-indentation  -gdwarf-3 -O0  -x c++ mjm_chromate.h  -lpthread -lreadline -o chromate.out
...
// wtf? nothing  - needs a session doh... ?  
//if ( m_chrome_with_head) { EvalRt("driver.driver.manage().window().minimize();", 0 ); }
/*
...
//StrTy nacmd1=spfx+"Network.enable\",\"params\":{},\"id\":";
//{
//CmdParam p;
//CommandInfo cc=CommandInfo("Network.enable", p, true,true);
//m_chrome_cmds["enable_netrowk"]=cc;
//}
...
{
//StrTy nacmd=spfx+"Input.dispatchMouseEvent\",\"params\":{\"type\":\"mouseMoved\",\"x\":100,\"y\":120},\"id\":";
CmdParam p;
...
//CmdParam p;
//p.add("discover",true);
//CommandInfo cc=CommandInfo("Target.setDiscoverTargets", p, true,true);
//m_chrome_cmds["discover_targets"]=cc;
//}
*/
...
//if (!false) { //StrTy nacmd1=spfx+"Emulation.setFocusEmulationEnabled\",\"params\":{},\"id\":";
//StrTy jscmd=spfx+"Emulation.setScriptExecutionDisabled\",\"params\":{\"value\":"+StrTy("false")+"},\"id\":";
//{Ragged r=CmdGet(fi,IdAdd(jscmd),flags); }
//if (fi.error!="" ) return 1; 

/*
StrTy nacmd1=spfx+"Emulation.setBeginFrameControlEnabled\",\"params\":{\"enabled\":"+StrTy("true")+"},\"id\":";
Ragged rq=CmdGet(fi,IdAdd(nacmd1),flags);
}
if (false)
// this is only supported in headless mode... doh 
{ StrTy nacmd1=spfx+"HeadlessExperimental.beginFrame\",\"params\":{},\"id\":";
Ragged rq=CmdGet(fi,IdAdd(nacmd1),flags);
}
}

{ StrTy nacmd1=spfx+"Animation.enable\",\"params\":{},\"id\":";
Ragged rq=CmdGet(fi,IdAdd(nacmd1),flags);
}

{ StrTy nacmd1=spfx+"Target.setDiscoverTargets\",\"params\":{\"discover\":true},\"id\":";
Ragged rq=CmdGet(fi,IdAdd(nacmd1),flags);
}
}
*/
