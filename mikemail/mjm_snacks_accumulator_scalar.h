...
class _add_or_append_type : public TypedVec
{
...
void UsedReport( Ragged & used,  const NostMap& nost,const Nmap &nmap, const bool include_units,
...
void MakeMaps(Nmap & nmap, Alphanmap & alphanmap, Ulmap & umap)
{
